...
<ul className='dot-list'>
  ...
  <li>Cardboard boxes, bale wrapping film or non-recyclable soiled fabric,

</li>
 <li>Plastic bags carrying chemical raw material,


</li>
 <li>Non-reusable paper cones and tubes,
</li>
<li>Waste fabrics, yarns, and fibres from non-recyclable processing.

</li>
</ul>

<p  style={{marginBottom:'17px', lineHeight:'1.7', fontSize:'17px' , color:'#666'}}>Unmanaged solid waste is likely to be dumped as landfill.

</p>
<p  style={{marginBottom:'17px', lineHeight:'1.7', fontSize:'17px' , color:'#666'}}>The textile and footwear industries consume high amounts of water and also threaten the water quality in China. The latest discharge standard, GB 42872012, serves as a way to enforce China’s Environmental Protection Law, and to encourage the improvement of production methods used in the textile dyeing and finishing industry and the improvement of pollution control technology. The standard covers the discharge limits, the requirements for monitoring and controlling for water pollutants in the textile dyeing and finishing industry or production facility.

</p>
<p  style={{marginBottom:'17px', lineHeight:'1.7', fontSize:'17px' , color:'#666'}}>The industries should follow the requirements for the pollution discharge and control in the standard and adapt necessary measures to ensure normal operation of the pollution control systems. From 1 January 2013 to 31 December 2014, current and all new factories should have been meeting the suggested discharge limits for water pollutants. Starting on 1 January 2015, current factories should meet the discharge limits set by CEPL. The Ministry of Environmental Protection (MEP) of the People’s Republic of China released a modification list for the existing GB 42872012 on 27 March 2015 (Louann, 2015).

</p>
<p  style={{marginBottom:'17px', lineHeight:'1.7', fontSize:'17px' , color:'#666'}}>In India, The National Green Tribunal’s (NGT) circuit bench of Jodhpur has ordered the closure of 739 textile units in Balotra and its surrounding areas of Jasol and Bithuja (Rajasthan state) till July 9, 2015. It has also ordered the trust operating the Common Effluent Treatment Plant (CETP) to renew the Consent to operate the plant and obtain the hazardous waste disposal authorization from the Rajasthan State Pollution Control Board. It is claimed that between them the units have been discharging 17-18 million litres of untreated effluent per day into the Dravyawati river. Local courts have ordered 213 units to close by May 31, 2015 and the remainder by June 30, 2015 with local police asked to support the order (Mathews, 2015.).

</p>
<p  style={{marginBottom:'17px', lineHeight:'1.7', fontSize:'17px' , color:'#666'}}>In 2012, more than half of India’s $1.25 billion worth of textile exports to the U.S. came from the southern city of Tirupur. While the business has brought economic benefits, its environmental and social costs are many. Downstream of Tirupur and its more than 300 textile factories, the Noyyal River had become foamy and discolored. Pollution from this industry is blamed for causing illness among local people and sapping the productivity of nearby farms.

</p>
<p  style={{marginBottom:'17px', lineHeight:'1.7', fontSize:'17px' , color:'#666'}}>Tirupur is not an isolated case. According to the World Bank, 20% of water pollution globally is caused by textile processing. Nongovernmental organizations (NGOs) such as environmental groups say parts of India and China are among the most polluted.

</p>
<p  style={{marginBottom:'17px', lineHeight:'1.7', fontSize:'17px' , color:'#666'}}>Major chemical companies as well as start-ups are responding by developing less harmful textile-processing chemicals. But such substances are often more expensive than ones in use. Lower-cost reagents and better enforcement by regulators are required, textile chemical executives say, along with a shift in consumer behaviour away from opting for the cheapest products.

</p>
<p  style={{marginBottom:'17px', lineHeight:'1.7', fontSize:'17px' , color:'#666'}}>The textile industry uses more than 8,000 chemicals to make the 400 billion m2 of fabric sold annually around the world. Many are toxic and persist in the environment. They include heavy-metal-rich dyes and fixing agents, bleaches, solvents, and detergents.

</p>
<p  style={{marginBottom:'17px', lineHeight:'1.7', fontSize:'17px' , color:'#666'}}>Making textiles is also a water-intensive business. Producing a pair of jeans requires about 1,800 gal of water; a T-shirt takes 700 gal. Treating such large volumes of waste water is costly—if it is treated at all.

</p>
<h5>Air Emissions
</h5>
<p  style={{marginBottom:'17px', lineHeight:'1.7', fontSize:'17px' , color:'#666'}}>Burnt fossil fuels contribute to the emissions of carbon dioxide, a primary contributor to the greenhouse effect. The textile manufacture is also responsible for the following emissions:

</p>
<ul className='dot-list'>
  <li>Nitrogen oxides and sulphur oxides (from fossil-fuel heated boilers) which create acidity in the natural environment (freshwater lakes, rivers, forests and soils) and lead to the deterioration of metal and building structures. They also contribute to smog formation in urban areas.
</li>
  <li>Solvent escaping into the air from drying ovens used in solvent coating operations.

</li>
 <li>Solvents released from cleaning activities (general facility clean-up and maintenance, print screen cleaning).

</li>
 <li>Emissions of volatile hydrocarbons which include non-methane hydrocarbons (NMHC) and oxygenated NMHC (e.g., alcohols, aldehydes and organic acids).
...
<p  style={{marginBottom:'17px', lineHeight:'1.7', fontSize:'17px' , color:'#666'}}>The fixing agents recommended are alum, stannous chloride, tartaric acid, ferrous sulphate and Turkey Red Oil. Tannins are used as natural mordants in the natural dyeing process, as they can enhance the affinity of different dyes. Tannins are naturally occurring phenolic compounds and those having o-dihydroxy groups form metal chelates after pre-treatment or post-treatment of the substrate with metal salts. Tannin-metal salt combinations, rather than the tannins themselves, can be considered as the mordant for natural dyes. Some important raw materials for tannins are oak bark and wood (Quercus infectoria), pomegranate rind (Punica granatum) and cutch (Acacia catechu) (Roy Choudhury, 2006).

</p>
<h5>Greener Dyeing Processes:
</h5>
<p  style={{marginBottom:'17px', lineHeight:'1.7', fontSize:'17px' , color:'#666'}}>To become environmentally responsible, dyers need to adopt the well-established “3R” principles of pollution prevention i.e. reduce, re-use and recycle; the most effective pollution prevention practice in textile wet processing is “right-first-time” dyeing. Corrective measures like shading additions, or stripping and re-dyeing processes, consume additional dyes and chemicals, water and energy (Holmes, 2012).

</p>

<p  style={{marginBottom:'17px', lineHeight:'1.7', fontSize:'17px' , color:'#666'}}>There are two basic approaches to pollution control:

</p>
<ul className='dot-list'>
  <li>Effluent treatment—or end-of-pipe solutions
</li>
  <li>Waste minimization—or source-reduction solutions
</li>
 
</ul>
<p  style={{marginBottom:'17px', lineHeight:'1.7', fontSize:'17px' , color:'#666'}}>The first approach has no financial payback whereas the waste minimisation approach not only reduces environmental impact but also minimises the cost of production and has the potential to make dyeing processes greener in several ways:

</p>
<ul className='dot-list'>
  <li>Process optimization aimed at reducing process time and energy consumption, for example, by the use of combined scour/dye processes)

</li>
  <li>Reduced consumption of water (ultra-low liquor ratio dyeing – 3:1 to 4:1 for polyester and 6:1 for cotton), electrical power and steam consumption.

</li>
<li>Promoting high exhaustion e.g., through the use of polyfunctional fibre-reactive dyestuffs which can give exhaustion in excess of 95% thus decreasing pollution.
</li>
<li>Continuous preparatory and dyeing methods instead of batch-wise methods minimizing consumption of energy, water and chemical to less than half.
</li>
<li>Semi-continuous cold pad–batch dyeing processes with reactive dyes instead of batch-wise or pad-steam methods (Kehry and Strohle, 2006).
</li>
<li>Chemical-free water-free denim processing using laser technology to burn away quickly the surface of the dyed denim fabric or a pair of jeans on a mannequin to replicate an authentic worn look. Conventionally, this is done with stones, oxidizing agents or enzymes by aqueous methods (Tarhan and Sariisik, 2009).
</li>
<li>Sustainable digital printing and heat transfer printing which require far less water and produces far less waste than the traditional printing methods (Fashion-incubator, 2010).
</li>
<li>Cold transfer printing process (Cooltrans) of reactive dyes at room temperature on pre-treated cotton, viscose, linen and silk thereby saving water and heat (Thiry, 2010).
</li>
<li>Supercritical carbon dioxide dyeing or waterless dyeing (Miah et al., 2013).
</li>

</ul>
<h5>Dyeing in Supercritical Carbon Dioxide:
</h5>
<p  style={{marginBottom:'17px', lineHeight:'1.7', fontSize:'17px' , color:'#666'}}>A supercritical fluid, a substance above its supercritical temperature and pressure (which for supercritical CO2 are 31.1°C and 73.8 bar respectively (Cid et al., 2005), has the properties midway between a gas and a liquid. When a gas is compressed it becomes increasingly dense and finally it is nearly as dense as a liquid, expanding to fill its container like a gas but with a density similar to that of a liquid. The practical application of supercritical fluids as dyeing media received considerable attention from researchers in the last decade of the 20th century, as illustrated by the review by Bach and co-workers (Bach etal, 2002). Carbon dioxide, has so far been the most widely used, because of its convenient critical point , cheapness, chemical stability, non-flammability, stability in radioactive applications and non-toxicity. Owing to small viscosity of supercritical

</p>
<p  style={{marginBottom:'17px', lineHeight:'1.7', fontSize:'17px' , color:'#666'}}>Carbon dioxide and to high diffusion coefficient of dyestuff molecules in this condition, disperse dyestuff molecules easily penetrate into fibres and as a result supercritical carbon dioxide dyeing provides a better dyestuff transportation compared to dyeing in water. The CO2 used is a waste product of combustion, fermentation and ammonia synthesis, so it does not have to be specially produced for dyeing.

</p>
<p  style={{marginBottom:'17px', lineHeight:'1.7', fontSize:'17px' , color:'#666'}}>The main advantages (Poliakoff and Licence, 2007) of using supercritical CO2 (scCO2) instead of water in a dyeing process are:

</p>
<ul className='dot-list'>
    <li>The easy separation of the CO2 and the unused dye remaining after the dyeing process. Depressurization leads to precipitation of the excess dye and gives clean, gaseous CO2, so that both compounds can be recycled and no waste is generated.
</li>
    <li>After the dyeing process, the textile does not need any energy-intensive drying step as in the case of aqueous dyeing.
</li>
