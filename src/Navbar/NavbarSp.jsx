...
<header class="site-header header-style-3">
  ...
  <Link class="navbar-brand"  style={{width:'20%',padding:'0'}}  to="/"><img src={logo} /></Link>
    ...
    <ul class=" navbar-nav  mb-2 mb-lg-0" style={{display:'flex', justifyContent:'space-evenly', width:'70%'}}>
                            <li class="nav-item ">
                                <Link className='nav-item' to='/' style={{textDecoration:'none', color:'#C0AB89', fontSize:'20px'}} onClick={verena}>Inicio</Link>
                               
                            </li>
                            <li><Link className='nav-item' to='/about'  style={{textDecoration:'none', color:'#C0AB89', fontSize:'20px'}} onClick={verena}>Sobre nosotros</Link></li>
                            <li><Link className='nav-item' to='/history'  style={{textDecoration:'none', color:'#C0AB89', fontSize:'20px'}} onClick={verena}>Historia</Link></li>

                            
                            <li class="nav-item">
                                <Link className='nav-item' to='/products'  style={{textDecoration:'none', color:'#C0AB89', fontSize:'20px'}} onClick={verena}>Productos</Link>
                                {/* <ul class="sub-menu">
                            ...
                            <li class="nav-item">
                                <Link className='nav-item' to='/galleryHome'  style={{textDecoration:'none', color:'#C0AB89', fontSize:'20px'}} onClick={verena}>Galería</Link>
                                {/* <ul class="sub-menu">
