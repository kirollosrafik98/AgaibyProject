    ...
    <>
      ...
      <div className="col-md-5">
        ...
        <Fade left duration={1000} delay={500}>
          ...
          &nbsp;&nbsp; هناك أشخاص حقيقيون وراء المصنع المصري السويسري يعاملون باحترام وإنصاف وأدب. نحن نؤمن بالعمل في وئام مع البيئة لإنشاء منتجات تحافظ على البيئة وتعكس قيمنا، مما يسمح لنا بأن نكون المؤسسة الرائدة والإبداعية في قطاعنا مع الحصول على رضا العملاء أيضا.
          </p>
        </Fade>
