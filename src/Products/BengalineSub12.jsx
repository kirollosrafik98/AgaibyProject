...
import dyedStretch1 from '../images/Products/Printed Bengaline Light for T-Shirt with Lycra - ‎بنجالين لايت مطبوع قميص وتيشرت/New Folder With Items 57/DSC_9284.jpg';
import dyedStretch2 from '../images/Products/Printed Bengaline Light for T-Shirt with Lycra - ‎بنجالين لايت مطبوع قميص وتيشرت/New Folder With Items 57/DSC_9285.jpg';


export default function BengalineSub12() {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  return (
