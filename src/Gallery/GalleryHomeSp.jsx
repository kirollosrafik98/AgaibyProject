...
export default function GalleryHomeSp() {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  return (
...
<div class="page-title">
            <div class="container">
            <Fade top duration={1000} delay={500}>  <h1 style={{color:'#C0AB89', fontFamily:'Millania', fontSize:'80px'}}>Galería</h1></Fade>
      ...
      <Fade right>
        <div class="grid">
          ...
          <div class="entry-details">
            <h3><a style={{textDecoration:'none', fontFamily:'Maya'}}>Sucursal Shubra</a></h3>
            {/* <span class="entry-date">30 November, 2018</span> */}
            <div class="entry-footer">
              <Link to='/branch1' style={{textDecoration:'none'}} class="read-more">Mostrar galería</Link>
    ...
    <div class="col-md-4 p-3">
      <Fade right>
        <div class="grid">
          ...
          <div class="entry-details">
            <h3><a style={{textDecoration:'none', fontFamily:'Maya'}}>Sucursal Gesr El Suez</a></h3>
            {/* <span class="entry-date">30 November, 2018</span> */}
            <div class="entry-footer">
              <Link to='/branch2' style={{textDecoration:'none'}} class="read-more">Mostrar galería</Link>
              {/* <a style={{textDecoration:'none'}} class="comments"><i class="fa fa-comments" aria-hidden="true"></i> 5</a> */}
            </div>
          </div>
        </div>
