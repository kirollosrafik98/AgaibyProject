...
export default function Branch2Fr() {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
    const settings = {
...
<div class="page-title">
            <div class="container">
            <Fade top duration={1000} delay={500}>  <h1 style={{color:'#C0AB89', fontFamily:'Millania', fontSize:'60px'}}>Sucursale de Gesr El Suez</h1></Fade>
